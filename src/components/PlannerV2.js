...
console.log('🚀 Planner.js module loaded! V2');
      ...
      img.onload = async function () {
        ...
        try {
          ...
          if (!token || token === 'null' || token === 'undefined') {
            alert('⚠️ Non sei loggato! Verrai reindirizzato al login.');
          ...
          if (response.status === 401 || response.status === 403) {
            alert(`⛔ DEBUG: Rilevato errore ${response.status}. Reindirizzamento...`);
    ...
    try {
      ...
      reader.onload = function (e) {
        ...
        img.onload = async function () {
          ...
          if (!token) {
            alert('⚠️ Devi effettuare il login per caricare le foto!');
          ...
          if (response.status === 401) {
            console.warn('⛔ Token rejected by server (401). Redirecting to login.');
