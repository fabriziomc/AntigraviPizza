  ...
  if (recipes.length > 0) {
    ...
    <input type="checkbox" name="selectedPizzas" value="${recipe.id}" ${isSelected ? 'checked' : ''} class="${isAutoGenerated ? 'auto-generated' : ''}" style="width: 20px; height: 20px;">
      <div style="flex: 1; display: flex; align-items: center; gap: 0.5rem;">
        <button class="btn-fav-selection" data-recipe-id="${recipe.id}" style="background: none; border: none; cursor: pointer; font-size: 1.25rem; padding: 0.25rem; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
          ${recipe.isFavorite ? '⭐' : '☆'}
        </button>
  ...
  const modalContent = `
    ...
    return `
                <li style="padding: 0.75rem; background: rgba(255,255,255,0.05); border-radius: 0.5rem; margin-bottom: 0.5rem; display: flex; align-items: center; justify-content: space-between;">
                  <div style="display: flex; align-items: center; gap: 0.75rem;">
                    <button class="btn-fav-toggle" data-recipe-id="${pizza.recipeId}" data-night-id="${nightId}" style="background: none; border: none; cursor: pointer; font-size: 1.25rem; padding: 0.25rem; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.2)'" onmouseout="this.style.transform='scale(1)'">
                       ${isFavorite ? '⭐' : '☆'}
                    </button>
