...
async function cleanTurso() {
    ...
    // Leggi le credenziali Turso da .env o .env.turso.example
    const tursoUrl = process.env.TURSO_DATABASE_URL;
    const tursoToken = process.env.TURSO_AUTH_TOKEN;

    if (!tursoUrl || !tursoToken) {
        console.log('⚠️  Credenziali Turso non configurate.');
        console.log('   Assicurati che TURSO_DATABASE_URL e TURSO_AUTH_TOKEN siano nel file .env\n');
        return 0;
    }
